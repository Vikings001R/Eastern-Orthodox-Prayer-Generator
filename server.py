...
def privacy():
    ...
    Contact Us:<br>
    For questions, contact [your email, e.g., yourname@example.com].<br>
...
def terms():
    ...
    Governing Law:<br>
    These Terms are governed by the laws of [your jurisdiction, e.g., United States].<br>
    Changes to Terms:<br>
    We may update these Terms. Continued use constitutes acceptance.<br>
    Contact Us:<br>
    For questions, contact [your email, e.g., yourname@example.com].</p>
    </body>
    </html>
    """
